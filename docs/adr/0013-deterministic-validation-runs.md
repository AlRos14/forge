...
Artifact without requiring an Actor, HarnessSession, or fake System Actor.
...
PR 8 introduces the durable validation/review representation and removes the
special review runtime after all readers and writers move. PR 0 only freezes
the distinction; it adds no schema or runtime behavior.
